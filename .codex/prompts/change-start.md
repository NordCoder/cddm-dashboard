...
If goal tools are available, create or adopt exactly this durable Goal. Goal creation failure is not a blocker. The Goal is an execution aid only and must allow a material HARD HOW conflict to terminate as BLOCKED rather than retry indefinitely.
