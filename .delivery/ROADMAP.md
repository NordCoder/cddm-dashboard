...
| #84 | Autopilot operator controls, status projection and fail-closed circuit breakers | Stacked draft PR #101 — QA pending |
| #85 | Restart, duplicate, stale-Head and multi-Issue continuous-loop soak verification | Stacked Candidate — verification pending |
