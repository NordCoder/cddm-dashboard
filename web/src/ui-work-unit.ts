...
export function WorkUnitContent(props: {
  ...
  return h(
    ...
    WorkerLoopPanel({ workUnit: item, execution: props.execution, readiness: props.readiness, workers: props.workers, busy: props.mutationBusy, feedback: props.mutationFeedback, onBindRole: props.onBindRole, onDisableRole: props.onDisableRole, onDeliveryMode: props.onDeliveryMode }),
