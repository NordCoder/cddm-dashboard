...
test('delivery inspector route identity covers work-unit and plan deep links only', () => {
  assert.deepEqual(deliveryRouteIdentity('/projects/4/work-units/81'), { projectID: 4, issueNumber: 81 })
  assert.deepEqual(deliveryRouteIdentity('/projects/4/work-units/81/plans'), { projectID: 4, issueNumber: 81 })
  assert.deepEqual(deliveryRouteIdentity('/projects/4/work-units/81/plans/9'), { projectID: 4, issueNumber: 81 })
